INSERT INTO categories (name, description, created_at, updated_at)
 ...
 VALUES
   ('DevTool Pro', 'The ultimate developer toolkit', 'Comprehensive development suite', 'Easy integration with existing workflow', '/icons/devtool.png', 'https://devtool.pro', '{"views": 0, "reviews": 0}', '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 1, NOW(), NOW()),
   ('DesignMaster', 'Design like a pro', 'Professional design platform', 'Intuitive interface for designers', '/icons/design.png', 'https://designmaster.app', '{"views": 0, "reviews": 0}', '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 2, NOW(), NOW()),
   ('MarketGenius', 'Smart marketing automation', 'AI-powered marketing platform', 'Automated marketing workflows', '/icons/market.png', 'https://marketgenius.io', '{"views": 0, "reviews": 0}', '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 3, NOW(), NOW()),
   ('CodeBuddy', 'Your coding companion', 'AI pair programming assistant', 'Real-time code suggestions', '/icons/code.png', 'https://codebuddy.dev', '{"views": 0, "reviews": 0}', '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 4, NOW(), NOW()),
   ('DataViz', 'Beautiful data visualization', 'Turn data into insights', 'Drag-and-drop visualization builder', '/icons/dataviz.png', 'https://dataviz.app', '{"views": 0, "reviews": 0}', '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 5, NOW(), NOW());
 ...
 VALUES
   (1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 5, 'Excellent developer tool!', NOW(), NOW()),
   (2, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 4, 'Great design features', NOW(), NOW()),
   (3, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 5, 'Amazing marketing automation', NOW(), NOW()),
   (4, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 4, 'Very helpful coding assistant', NOW(), NOW()),
   (5, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 5, 'Powerful visualization tool', NOW(), NOW());
 ...
 VALUES
   ('Getting Started with DevTool Pro', 'A comprehensive guide to DevTool Pro...', 1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NOW(), NOW()),
   ('Design Tips and Tricks', 'Essential design principles...', 2, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NOW(), NOW()),
   ('Marketing Automation Best Practices', 'How to automate your marketing...', 3, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NOW(), NOW()),
   ('Launching Your First Product', 'Steps to a successful product launch...', 4, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NOW(), NOW()),
   ('AI in Modern Development', 'How AI is changing development...', 5, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NOW(), NOW());
 ...
 VALUES
   (1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'Great post about DevTool Pro!', NOW(), NOW()),
   (2, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'These design tips are very helpful', NOW(), NOW()),
   (3, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'Marketing automation is crucial', NOW(), NOW()),
   (4, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'Launch strategy is on point', NOW(), NOW()),
   (5, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'AI is indeed transforming development', NOW(), NOW());
 
 -- Seed gpt ideas
 INSERT INTO gpt_ideas (idea, views, claimed_by, created_at)
 VALUES
   ('AI-powered code review assistant', 0, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NOW()),
 ...
 VALUES (1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NOW());
 
 -- Seed messages
 INSERT INTO messages (message_room_id, sender_id, content, created_at)
 VALUES
   (1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'Hello! Interested in collaboration', NOW()),
   (1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'Let''s discuss the project details', NOW()),
   (1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'What''s your availability?', NOW()),
   (1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'I can start next week', NOW()),
   (1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'Great, looking forward to working together', NOW());
 
 -- Seed notifications
 INSERT INTO notifications (source_id, product_id, post_id, target_id, type, created_at)
 VALUES
   ('94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 1, NULL, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'review', NOW()),
   ('94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NULL, 1, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'reply', NOW()),
   ('94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NULL, NULL, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'follow', NOW()),
   ('94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', NULL, 2, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'mention', NOW()),
   ('94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 2, NULL, '94cd0e78-39b0-4fe2-a2ca-a8eb656ff07b', 'review', NOW());
